#Let's say you wanted to build your own DHCP server one thing you gonna need to do is proide a way to generate IP addresses. Sipasa does this part for you.
